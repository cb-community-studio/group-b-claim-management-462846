...
const UsersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.plan}</p>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="phoneNo" header="Phone Number" body={pTemplate4} sortable style={{ minWidth: "8rem" }} />
            <Column field="plan" header="Plan" body={pTemplate5} style={{ minWidth: "8rem" }} />
